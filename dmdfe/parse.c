...
{   AggregateDeclaration *a = NULL;
	...
	unsigned int loc_start = token.pos;
	unsigned int loc_idstart = 0;
	unsigned int loc_idend = 0;
...
Array *Parser::parseDeclarations()
{
	...
	loc.idstart = decl_idstart;
	loc.idend = decl_idend;
	loc.end = cc;
