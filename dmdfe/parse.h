...
struct Parser : Lexer
{
	...
	bool decl_waitid; // waiting declaration identifier flag.
	unsigned int decl_idstart; // position of the last identifier from parseDeclarator.
	unsigned int decl_idend;
